...
class PostPreview extends StatefulWidget {
  ...
  PostPreviewState createState() {
    return PostPreviewState(anomaly: this.anomaly, reported: this.reported);
  }
}
  ...
  Widget build(BuildContext context) {
    return StoreConnector<AppState, dynamic>(
        converter: (Store<AppState> store) {
          return (BuildContext context, String anomaly) => store.dispatch(addReport(
              context,
              store.state.auth.user.authToken,
              new Report(
                  user: store.state.auth.user.id.toString(), anomaly: anomaly)));
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Padding(
                            ...
                            child: Text(calculateTime(anomaly.post.createdAt))),
                        StoreConnector<AppState, AppState>(
                            converter: (store) => store.state,
                            builder: (context, state) {
                              if (state.auth.user.id != anomaly.post.owner.id){
                                return IconButton(
                                  icon: Icon(Icons.info, color: Colors.blueGrey),
                                  onPressed: () {
                                    print(reported.toString() +
                                        "-----------" +
                                        anomaly.id.toString());
                                    if (!reported) {
                                    ...
                                    if (_isButtonDisabled) {
                                      Toast.show("Already reported", context,
                        ...
                        child: StoreConnector<AppState, Store<AppState>>(
                          ...
                          builder: (context, store) => IconButton(
                              icon: Icon(Icons.keyboard_arrow_up,
                                  color: store.state.feedState.anomalies.firstWhere((e) => e.id == anomaly.id).post.userReaction != null
                                      ? store.state.feedState.anomalies
                                      .firstWhere((e) => e.id == anomaly.id)
                                      .post
                                      .userReaction
                                      ...
                                      : Colors.grey
                                      : Colors.grey),
                              onPressed: () => store.state.feedState.anomalies
                                  .firstWhere((e) => e.id == anomaly.id)
                                  .post
                                  .userReaction !=
                                  null
                                  ...
                                  .isLike
                                  ? store.dispatch(
                                  new UpdateReactionAction(anomaly: anomaly, reaction: anomaly.post.userReaction))
                        ...
                        child: StoreConnector<AppState, Store<AppState>>(
                          ...
                          builder: (context, store) => IconButton(
                            icon: Icon(Icons.keyboard_arrow_down,
                                color: store.state.feedState.anomalies
                                    .firstWhere((e) => e.id == anomaly.id)
                                    .post
                                    .userReaction !=
                                    null
                            ...
                            onPressed: () {
                              store.state.feedState.anomalies
                                  ...
                                  .userReaction
                                  .isLike
                                  ? store.dispatch(new UpdateReactionAction(
                                  anomaly: anomaly,
                                  reaction: anomaly.post.userReaction))
                                  : store.dispatch(new DeleteReactionAction(
                                  anomaly: anomaly))
